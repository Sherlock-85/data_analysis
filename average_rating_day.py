...
data = pandas.read_csv(r"C:\Users\kirst\pythonProject1\pythonProject1\pythonProject\data_analysis\review_analysis\
reviews.csv", parse_dates=["Timestamp"])
...
def app():
    ...
    p1 = jp.QDiv(a=webpage, text="These graphs represent course review analysis", classes="text-h5 q-p1-md")
    high_charts = jp.HighCharts(a=webpage, classes='m-2 p-2 border')
    high_charts.options = chart_definition
    high_charts.options.title.text = "Average Rating by Day"
